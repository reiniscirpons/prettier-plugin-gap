...
function(o) return "XYZ"; end;

function() MakeReadWriteGlobal(w); UnbindGlobal(w); end;
...
function(r,m) return ResidueClass(Integers,m,r); end;

function ( t ) result.chart.type := t; end;

function() unknownvarname := 1; end;

function(u,v) return LtNP(u[3],v[3]);end;

function(t1,t2) return t1[1] = t2[1]; end;

function() Display(obj); end;
