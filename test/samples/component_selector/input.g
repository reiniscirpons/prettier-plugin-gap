...
celldata[2]
			[torsionCells[2][q][2]]!.BoundaryImage;
...
MMMINIMIZE@(FamilyObj(M),AlphabetOfFRObject(M),
        M!.nrstates,M!.transitions,M!.output,fail,0)!.nrstates;

ElementsFamily( FamilyObj(
             UnderlyingLeftModule( B ) ) )!.basisVectors;

FpGModule
                (ReducedB1,G,prime)!.dimension;

LatticeByCyclicExtension(f,
          [u -> IsSubset(HN, u), u -> IsSubset(HN, u)])!.conjugacyClassesSubgroups;

PackageInfo("intpic")[1]!.
        InstallationPath;
